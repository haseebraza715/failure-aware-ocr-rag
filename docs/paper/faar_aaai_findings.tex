...
The OHR-Bench split is fixed with seed 42. It contains 5,948 training questions, 1,274 validation questions, and 1,276 test questions. After resolving the audited dataset naming aliases, the validation split covers 549 documents and 7,037 complete-document pages, and the test split covers 567 documents and 6,849 pages. Retrieval corpora are required to contain the complete document rather than only the gold evidence pages.
...
\midrule
\path{docs/history/aaai-execution-status.md} & AAAI phase status, implementation-versus-execution distinction, and blockers. \\
\path{docs/experiments/aaai-plan.md} & Ordered B0 to B4 commands and completion checklist. \\
\path{docs/history/runlog.md} & Split counts, smoke measurements, asset preparation, verification, and blockers. \\
