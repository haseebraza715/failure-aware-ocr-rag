...
Use [Phase 5 Writing Plan](https://github.com/haseebraza715/FailSafeRAG/blob/main/docs/phases/phase5/writing_plan.md) as the default handoff document for drafting.
