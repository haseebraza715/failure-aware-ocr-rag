...
- Write `evaluate.py` using RAGAS. It must output `EM`, `F1`, `vlm_rate`, and `harm_rate`.
...
```bash
python run.py --gate off --recovery off --out results/b0.json
python run.py --gate off --recovery always_vlm --out results/b1.json
python run.py --gate on --recovery random_type --out results/b2.json
python run.py --mode colpali --out results/b3.json
python run.py --mode visrag --out results/b4.json
```
...
```bash
python run.py --ablate no_gate --out results/a1.json
python run.py --ablate no_diagnosis --out results/a2.json
python run.py --ablate no_wordlevel_llm --wordlevel_fallback symspell --out results/a3.json
python run.py --ablate no_semantic_retry --out results/a4.json
```
...
- [ ] `split.json` committed to repo
- [ ] `evaluate.py` outputs all 4 metrics
